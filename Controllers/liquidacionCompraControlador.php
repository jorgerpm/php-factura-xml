...
class liquidacionCompraControlador extends liquidacionCompraModelo {
    ...
    public function cargar_liquidacioncompra_controlador() {
        ...
        $extFile = mb_strtolower($extFile, 'utf-8'); //String cambia las letras a minúsculas; strtoupper pone en mayúsculas
        ...
        if(strlen($_POST['numeroLC']) == 15){
            ...
            return "<script>swal('','El número de liquidación debe tener 15 dígitos.','warning');</script>";
        }
